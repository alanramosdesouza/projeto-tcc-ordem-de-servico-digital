...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Solicitacao o1 = new Solicitacao(null, Instant.parse("2019-06-20T19:53:07Z"), u1);
		Solicitacao o2 = new Solicitacao(null, Instant.parse("2019-07-21T03:42:10Z"), u2);
		Solicitacao o3 = new Solicitacao(null, Instant.parse("2019-07-22T15:21:22Z"), u1);
